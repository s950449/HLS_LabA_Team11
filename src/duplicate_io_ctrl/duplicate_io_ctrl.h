...
#pragma hls_design
    void CONTROL(hls::stream<ctr_type>& ctrl, hls::stream<ctr_type>& ctrl0, hls::stream<ctr_type>& ctrl1) {
...
#pragma hls_design
    void BLOCK0(hls::stream<dat_type>& din, hls::stream<dat_type>& dout, hls::stream<ctr_type>& ctrl) {
#pragma HLS PIPELINE II = 1
...
#pragma hls_design
    void BLOCK1(hls::stream<dat_type>& din, hls::stream<dat_type>& dout, hls::stream<ctr_type>& ctrl) {
#pragma HLS PIPELINE II = 1
        ctr_type ctrl_int = ctrl.read();
        WRITE:for (ctr_type i = 0; i < 255; i++) {
            if (i == ctrl_int) break;
