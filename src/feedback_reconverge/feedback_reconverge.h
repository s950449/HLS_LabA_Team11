...
#pragma hls_design
    void BLOCK1(hls::stream<uint4>& din, hls::stream<uint4>& dout) {
...
#pragma hls_design
    void BLOCK2(hls::stream<uint4>& din1, hls::stream<uint4>& dout) {
#pragma HLS PIPELINE II = 1 enable_flush
        uint4 tmp;
        tmp = din1.read() + 111;
        dout.write(tmp);
...
#pragma hls_design
    void BLOCK3(hls::stream<uint4>& din0, hls::stream<uint4>& din1, hls::stream<uint4>& dout) {
#pragma HLS PIPELINE II = 1 enable_flush
        uint4 tmp;
